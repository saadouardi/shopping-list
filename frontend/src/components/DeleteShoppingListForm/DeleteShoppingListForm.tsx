...
const DeleteItemForm = () => {
    ...
    return (
        <>
            ...
            {deleteItem &&
                <div className='z-3 alert alert-danger position-fixed top-50 start-50 translate-middle w-25' role='alert'>
                    ...
                    <div className='d-flex justify-content-center gap-2'>
                        ...
                        <button type="button" className='btn btn-danger' onClick={handlesetDeleteItem}>Delete</button>
                    </div>
                </div>
            }
        </>
